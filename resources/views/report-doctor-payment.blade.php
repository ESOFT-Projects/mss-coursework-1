                    ...
                    <section class="panel">
                                ...
                                <form class="form-inline" role="form" style="display:inline;margin-right:0px;">
                                    ...
                                    <div class="form-group">
                                        <a type="button" class="btn btn-primary btn-sm m-bot15"
                                           ng-click="export_doctor_report_pdf();"><i class='fa fa-print'></i>&nbsp;EXPORT PDF</a>
                                    </div>
                        ...
                        <div class="panel-body">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                <tr ng-repeat="payment in doctorPayments">
                                    <td style="text-align:center;">@{{$index+1}}</td>
                                    <td style="text-align:center;">@{{payment.employee.first_name + ' ' + payment.employee.last_name}}</td>
                                    <td style="text-align:center;">LKR @{{payment.amount}}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
